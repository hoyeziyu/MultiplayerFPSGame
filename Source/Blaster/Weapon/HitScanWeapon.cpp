...
FVector AHitScanWeapon::TraceEndWithScatter(const FVector& TraceStart, const FVector& HitTarget)
{
	...
	FVector RandVec = UKismetMathLibrary::RandomUnitVector() * FMath::FRandRange(0.f, SphereRadius);    // 随机向量
	...
	return FVector(TraceStart + ToEndLoc * TRACE_LENGTH / ToEndLoc.Size()); // 这里除以ToEndLoc.Size()为了float不溢出
}